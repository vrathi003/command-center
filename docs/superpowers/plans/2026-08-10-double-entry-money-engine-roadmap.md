...
| **P5** ✅ Done | [`2026-08-11-double-entry-money-engine-p5.md`](./2026-08-11-double-entry-money-engine-p5.md) · [design](../specs/2026-08-11-double-entry-money-engine-p5-design.md) · [acceptance report](../../../.superpowers/sdd/task-7-report.md) | Standalone AlertService + in-app channel; later Discord channel | P1 (events/outbox) |
