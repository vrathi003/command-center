...
| [`guide/setup-from-scratch.md`](guide/setup-from-scratch.md) | **From-scratch install** (local → systemd → Discord / Gmail / LLM / Tailscale) |
| [`guide/`](guide/) | Sphinx + MyST sources (setup, ledger, workflows, dashboard, reference) |
...
| `SETUP_AND_OPERATIONS.md`, `CREDIT_CARDS.md`, `2026-08-11-money-engine-changes-brief.md`, … | Standalone topic notes |
