...
def _row(r: tuple[Any, ...]) -> IncomeSourceRow:
    return IncomeSourceRow(
        ...
        taxability=str(r[5]),
        is_active=bool(r[6]),
        default_account_id=int(r[7]) if r[7] is not None else None,
        category=str(r[8]) if r[8] is not None else None,
    )
...
async def list_income_sources(
    ...
    *,
    ...
    cols = """
        id, name, type, amount_paise, frequency, taxability, is_active,
    ...
    *,
    ...
    cur = await conn.execute(
        ...
        INSERT INTO income_sources (
            name, type, amount_paise, frequency, taxability, is_active,
            default_account_id, category, updated_at
        ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, datetime('now'))
        """,
        (
            name,
    ...
    *,
    ...
    await conn.execute(
        ...
        UPDATE income_sources SET
            ...
            is_active = ?, default_account_id = ?, category = ?,
